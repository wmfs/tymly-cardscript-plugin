...
(user_id, state_machine_title, state_machine_category,
  todo_title, description, required_human_input, launches, id)
VALUES
('test-team-member', 'Process expense claim', 'expenses', 'Walter White',
 'Walter White is claiming $35 for A large plastic container', '{}', '{}',
 '77777777-ce99-11e7-b7e3-c38932399c15');

INSERT INTO tymly.todos
(team_name, state_machine_title, state_machine_category,
  todo_title, description, required_human_input, launches, id)
VALUES
('test-team', 'wmfs_addIncidentSafetyRecord', 'incidents', '1234/2017',
 'RTC with 3 casualties and 0 fatalities', '{}', '{}',
 '88888888-ce99-11e7-b7e3-c38932399c15');
