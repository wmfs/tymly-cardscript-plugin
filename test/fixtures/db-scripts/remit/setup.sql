...
INSERT INTO tymly.todos (user_id, state_machine_title, state_machine_category, todo_title, id)
VALUES ('test-team-member', 'wmfs_bookSomeoneSick_1_0', 'hr', 'Vincent Vega', 'a69c0ae8-cde5-11e7-abc4-cec278b6b50a');
INSERT INTO tymly.todos (team_name, state_machine_title, state_machine_category, todo_title, id)
VALUES ('test-team', 'wmfs_addIncidentSafetyRecord', 'incidents', '1234/2017', 'a69c0dcc-cde5-11e7-abc4-cec278b6b50a');
INSERT INTO tymly.todos (team_name, state_machine_title, state_machine_category, todo_title, id)
